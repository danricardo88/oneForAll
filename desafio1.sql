...
DROP DATABASE IF EXISTS SpotifyClone;
  ...
  CREATE TABLE SpotifyClone.tabela_favoritos (
  ...
  CREATE TABLE SpotifyClone.tabela_musicas (
  ...
  INSERT INTO SpotifyClone.tabela_plano (plano, valor)
  VALUES
    ("gratuito", 0.00),
    ("familiar", 7.99),
    ("universitario", 5.99),
  ...
  INSERT INTO SpotifyClone.tabela_usuario (usuario_nome, idade, plano_id, data_assinatura)
  VALUES
  ...
  INSERT INTO SpotifyClone.tabela_albuns (album_nome, data_de_lancamento, artista_id)
  VALUES
    ("Renaissance", 2022, 1),
    ("Jazz", 1978, 2),
    ("Hot Space", 1982, 2),
  ...
  INSERT INTO SpotifyClone.tabela_favoritos (usuario_id, artista_id)
  VALUES
    (1, 1),
    (1, 2),
    (1, 3),
  ...
  INSERT INTO SpotifyClone.tabela_musicas (nome_musica, duracao, artista_id, album_id)
  VALUES
